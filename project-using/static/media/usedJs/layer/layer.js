...
;!function (e, t) {
    ...
    var i, n, a = e.layui && layui.define, o = {
        ...
        v: "3.0", ie: function () {
            ...
            var l = "function" == typeof n, f = o.config.skin, c = (f ? f + " " + f + "-msg" : "") || "layui-layer-msg", u = s.anim.length - 1;
            ...
            }, l && !o.config.skin ? {skin: c + " layui-layer-hui", anim: u} : function () {
    ...
    s.anim = ["layer-anim", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], l.pt.config = {
        ...
        var n = this, a = n.index, r = n.config, l = r.zIndex + a, f = "object" == typeof r.title, c = r.maxmin && (1 === r.type || 2 === r.type), u = r.title ? '<div class="layui-layer-title" style="' + (f ? r.title[1] : "") + '">' + (f ? r.title[0] : r.title) + "</div>" : "";
        ...
        var f = [l.innerWidth(), l.innerHeight()], c = l.find(s[1]).outerHeight() || 0, u = l.find("." + s[6]).outerHeight() || 0;
        switch (o.type) {
            case 2:
                t("iframe");
                break;
        ...
        return t.move && s.css("cursor", "move"), s.on("mousedown", function (e) {
            ...
            if (c.moveStart) {
                ...
                if (i.preventDefault(), c.stX = s ? 0 : n.scrollLeft(), c.stY = s ? 0 : n.scrollTop(), !t.moveOut) {
                    var f = n.width() - l.outerWidth() + c.stX, u = n.height() - l.outerHeight() + c.stY;
        ...
        a.attr("minLeft");
        l !== o.type[3] && l !== o.type[4] && (n || (parseFloat(t.width) <= 260 && (t.width = 260), parseFloat(t.height) - f - c <= 64 && (t.height = 64 + f + c)), a.css(t), l === o.type[2] ? a.find("iframe").css({height: parseFloat(t.height) - f - c}) : r.css({height: parseFloat(t.height) - f - c - parseFloat(r.css("padding-top")) - parseFloat(r.css("padding-bottom"))}))
    }, r.min = function (e, t) {
    ...
    r.prompt = function (e, t) {
        ...
        var l = {};
        if (t = t || {}, t.photos) {
            var s = t.photos.constructor === Object, f = s ? t.photos : {}, u = f.data || [], d = f.start || 0;
            if (l.imgIndex = (0 | d) + 1, t.img = t.img || "img", s) {
                ...
                if (n || y.on("click", t.img, function () {
                        ...
                        r.photos(i.extend(t, {photos: {start: n, data: u, tab: t.tab}, full: t.full}), !0), p()
                    }), !n)return
            }
            ...
            }, l.loadi = r.load(1, {shade: !("shade" in t) && .9, scrollbar: !1}), o(u[d].src, function (n) {
